...
export const getTodoId = async (req: Request, res: Response): Promise<void> => {
...
export const addTodo = async (req: Request, res: Response): Promise<void> => {
  ...
  if (!body.title || !body.status) {
    res
      .status(401)
      .json({ status: 401, message: 'todo tittle or status nothing here' });
    return;
  }
...
export const updateTodo = async (
  ...
  res
    ...
    .json({
      status: 201,
      message: 'todo succes created edit',
